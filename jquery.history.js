 ...
 *
 * Modified by Simon Cross to allow the load() method to be called with a parameter which lets
 * the hash change without the callback function being fired
 */
...
$.extend(History.prototype, {
	...
	load: function(hash, call_callback) {
		var newhash;
		
		if (call_callback != false){
		  call_callback = true;
		}
